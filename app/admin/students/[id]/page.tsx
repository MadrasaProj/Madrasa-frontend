...
import { User, Phone, Calendar, Loader2, GraduationCap, Hash, Pencil, Trash2, Users, Heart, MapPin, AlertCircle } from "lucide-react";
...
export default function StudentDetailPage() {
  ...
  setDeleting(true);
  try {
  const { deleteStudent } = await import("@/lib/students-api");
