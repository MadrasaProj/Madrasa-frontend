        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            {type === "PARENT" && (
              <div>
                ...
                <Input
                  ...
                  className="h-12 rounded-xl bg-gray-50 text-gray-900 disabled:opacity-60"
                  required
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 rounded-xl bg-gray-50 pr-12 text-gray-900 disabled:opacity-60"
                  required
                  disabled={mustSetPassword}
                />
                <Button
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 rounded-xl bg-gray-50 pr-12 text-gray-900"
                      required
                    />
                    <Button
                      variant="ghost" size="icon"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="h-auto w-full rounded-xl bg-emerald-600 py-3.5 text-sm hover:bg-emerald-700"
            >
              {loading ? (
                <>
