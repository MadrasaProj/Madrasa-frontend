  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        onClick={onImport}
        className="w-full bg-emerald-600 text-white font-bold py-4 rounded-2xl text-base shadow-lg shadow-emerald-200 disabled:opacity-40 active:scale-[0.98] transition-transform"
      >
...
function ResultsScreen({
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        onClick={onDone}
        className="w-full bg-emerald-600 text-white font-bold py-4 rounded-2xl text-base shadow-lg shadow-emerald-200 active:scale-[0.98] transition-transform"
      >
        Done
      </button>
    </div>
